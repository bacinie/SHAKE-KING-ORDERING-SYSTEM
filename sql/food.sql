...
(2, 'Customer', 'Alex Mercer', 'alexm', 'pass123', 'alex@example.com', '124 Baker Street, London', 9898000101, 1, 0),
(3, 'Customer', 'Sarah Jenkins', 'sarahj', 'secure55', 'sarah@example.com', '742 Evergreen Terr, Spr', 9898000102, 1, 0),
(4, 'Customer', 'Michael Chang', 'mikec', 'foodie99', 'mike@example.com', '45 Oakridge Ave, Toron', 9898000103, 1, 0),
(5, 'Customer', 'Elena Rostova', 'elenar', 'rosto00', 'elena@example.com', '12 Primrose Lane, Sydn', 9898000104, 1, 0);
